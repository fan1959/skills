...
description: "Manage GitHub issues, PRs, releases, and marketing with parallel subagent army. ACTIVELY TRIGGER on: triaging issues, reviewing PRs, releasing versions, writing LinkedIn posts, announcing releases, fixing bugs, merging contributions, validating ENV vars, testing adapters, syncing branches, or any multi-agent GitHub workflow. PROACTIVELY use parallel subagents (10-20) for tasks involving multiple independent workstreams - don't do them sequentially, orchestrate them in parallel. Trigger on phrases like handle this GitHub task, review all open PRs, do a release, write release notes, announce on LinkedIn, fix all bugs tagged X, sync branches, validate adapters, orchestrate agents for X.", PRs, releases, and marketing with parallel subagent army. Orchestrates 10-20 dynamic agents per task. Use when triaging issues, reviewing PRs, releasing versions, writing LinkedIn posts, announcing releases, fixing bugs, merging contributions, validating ENV vars, testing adapters, or syncing branches.
allowed-tools: Read, Bash, Agent, Write, Glob, Grep
---
