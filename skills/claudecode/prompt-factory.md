---
name: prompt-factory
description: "Generate world-class prompts for any role, industry, and task. ACTIVELY TRIGGER when: user wants to create a better prompt, improve results, generate prompts for AI tools, create persona/system prompts, design prompt templates, or asks how do I write a better prompt for X. PROACTIVELY suggest this when user is frustrated with AI output quality, wants custom prompts for specific tools, or needs structured prompts for specific roles (developer, marketer, designer, analyst, etc.). Trigger on phrases like write a prompt for X, better prompt, system prompt, prompt template, optimize my prompt, generate a prompt, prompt engineering, I want Claude to act as X. Includes 69 presets across 15 professional domains and supports XML/Claude/ChatGPT/Gemini formats." that generates production-ready mega-prompts for any role, industry, and task through intelligent 7-question flow, 69 comprehensive presets across 15 professional domains (technical, business, creative, legal, finance, HR, design, customer, executive, manufacturing, R&D, regulatory, specialized-technical, research, creative-media), multiple output formats (XML/Claude/ChatGPT/Gemini), quality validation gates, and contextual best practices from OpenAI/Anthropic/Google. Supports both core and advanced modes with testing scenarios and prompt variations.
